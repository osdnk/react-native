...
type EasingFunction = (t: ExpressionNode) => ExpressionNode;
...
export default class Easing {
   ...
   */
  static linear(t: ExpressionNode): ExpressionNode {
    return t;
  }
   ...
   */
  static ease(t: ExpressionNode): ExpressionNode {
   ...
   */
  static quad(t: ExpressionNode): ExpressionNode {
    return multiply(t, t);
  }
   ...
   */
  static cubic(t: ExpressionNode): ExpressionNode {
   ...
   */
  static sin(t: ExpressionNode): ExpressionNode {
   ...
   */
  static circle(t: ExpressionNode): ExpressionNode {
   ...
   */
  static exp(t: ExpressionNode): ExpressionNode {
   ...
   */
  static bounce(t: ExpressionNode): ExpressionNode {
  ...
  static bezier(
    ...
    return (t: ExpressionNode) => bezier(t, x1, y1, x2, y2);
  }
